...
import { getRanomPrompt } from "../utils";
...
const CreatePost = () => {
  ...
  const handleSurpiseMe = () => {
    const randomPropmt = getRanomPrompt(form.prompt);
    setForm({ ...form, prompt: randomPropmt })
  };
  return (
    <section className="max-w-7xl mx-auto bg-[#222328] border-4 px-4 py-4">
      <div className=" text-white">
        <h1 className="font-extrabold text-[32px]">Create</h1>
        <p className="mt-2 text-[#666e75] text-[14px] max-w-[500px]">
          Create imaginative and visually stunning images through DALL-E AI, remember your only limit is your imagination
        </p>
      </div>

      <form className="mt-4 max-w-3xl  text-white">
